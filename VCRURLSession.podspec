Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |cs|
    ...
    cs.public_header_files = 'VCRURLSession/{VCRURLSession,VCRURLSessionCassette,VCRURLSessionPlayerDelegate,VCRURLSessionRecorderDelegate,VCRURLSessionPlayerMode,VCRURLSessionResponse}.h'
  end
